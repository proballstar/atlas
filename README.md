...
<!-- <img src="./svg/rocket/rocket.svg" alt="Atlas Rocket Ship" />-->
<svg width="98px" height="98px" viewBox="0 0 98 98" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
    ...
    <defs>
        <path id="path-1" d="M0,11 C0,7.48239496 4.67649685,-8.8817842e-16 6.5,0 C8.32350314,8.8817842e-16 13,7.48239497 13,11 L13,45.0007795 C13,47.762555 10.7652338,50 8.00693485,50 L4.99306515,50 C2.23595402,50 1.49213975e-13,47.7615739 1.38555833e-13,45.0007795 L0,11 L0,11 Z"></path>
    </defs>
    <g id="v2" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
        <g id="maintenance" sketch:type="MSArtboardGroup" transform="translate(-672.000000, -317.000000)">
            <g id="rocket-ship" sketch:type="MSLayerGroup" transform="translate(672.000000, 317.000000)">
                <circle id="Oval-228" fill="#DBE2E8" sketch:type="MSShapeGroup" cx="49" cy="49" r="49"></circle>
                <g id="illustration" transform="translate(9.000000, 4.000000)">
                    ...
                    <g id="stair" transform="translate(0.000000, 71.000000)" stroke="#2E3D49" stroke-width="2" stroke-linecap="square" sketch:type="MSShapeGroup">
                        <path d="M5,2 L16.5,13.5" id="Line"></path>
                        <path d="M0,1 L17.5,1" id="Line-Copy"></path>
                    </g>
                    <g id="stair-copy" transform="translate(0.000000, 58.000000)" stroke="#2E3D49" stroke-width="2" stroke-linecap="square" sketch:type="MSShapeGroup">
                        <path d="M5,2 L16.5,13.5" id="Line"></path>
                        <path d="M0,1 L17.5,1" id="Line-Copy"></path>
                    </g>
                    <g id="stair-copy-2" transform="translate(1.000000, 45.000000)" stroke="#2E3D49" stroke-width="2" stroke-linecap="square" sketch:type="MSShapeGroup">
                        <path d="M4,2 L15.5,13.5" id="Line"></path>
                        <path d="M0,1 L16.5,1" id="Line-Copy"></path>
                    </g>
                    <g id="stair-copy-3" transform="translate(1.000000, 32.000000)" stroke="#2E3D49" stroke-width="2" stroke-linecap="square" sketch:type="MSShapeGroup">
                        <path d="M4,2 L15.5,13.5" id="Line"></path>
                        <path d="M0,1 L16.5,1" id="Line-Copy"></path>
                    </g>
                    <g id="stair-copy-4" transform="translate(1.000000, 18.000000)" stroke="#2E3D49" stroke-width="2" stroke-linecap="square" sketch:type="MSShapeGroup">
                        <path d="M4,2 L15.5,13.5" id="Line"></path>
                        <path d="M0,1 L16.5,1" id="Line-Copy"></path>
                    </g>
                    <rect id="Rectangle-664-Copy-3" stroke="#2E3D49" stroke-width="2" stroke-linejoin="round" fill="#F95C3C" sketch:type="MSShapeGroup" transform="translate(5.500000, 11.500000) scale(1, -1) translate(-5.500000, -11.500000) " x="0" y="10" width="11" height="3"></rect>
                    <rect id="Rectangle-664-Copy-4" stroke="#2E3D49" stroke-width="2" stroke-linejoin="round" fill="#F95C3C" sketch:type="MSShapeGroup" transform="translate(11.500000, 16.000000) scale(1, -1) translate(-11.500000, -16.000000) " x="5" y="13" width="13" height="6"></rect>
                    <g id="back" transform="translate(31.000000, 10.000000)" stroke="#2E3D49" stroke-width="2" sketch:type="MSShapeGroup">
                        ...
                        <path d="M11,19 C11,6 20.1304348,5.99012021e-16 21.5,0 C22.8695652,-5.99012012e-16 32,6 32,19 L32,74.004248 C32,74.5541866 31.5613852,75 31.0012539,75 L11.9987461,75 C11.4471539,75 11,74.5492312 11,74.004248 L11,19 Z" id="large-capsul" stroke-linejoin="round" fill="#02B3E4"></path>
                        <path d="M-4.03233003e-14,24.0434783 C-1.94511074e-13,17 4,16 4,16 C4,16 8,17 8,24.0434783 L8,75.0084939 C8,75.5560876 7.54696369,76 7.00296986,76 L0.997030139,76 C0.446385598,76 -1.84613136e-13,75.5508329 -1.83093857e-13,75.0084939 L-4.03233003e-14,24.0434783 Z" id="left-capsul" stroke-linejoin="round" fill="#DBE2E8"></path>
                        <path d="M35,24.0434783 C35,17 39,16 39,16 C39,16 43,17 43,24.0434783 L43,75.0084939 C43,75.5560876 42.5469637,76 42.0029699,76 L35.9970301,76 C35.4463856,76 35,75.5508329 35,75.0084939 L35,24.0434783 Z" id="right-capsul" stroke-linejoin="round" fill="#DBE2E8"></path>
                    </g>
                    <g id="space-ship" transform="translate(27.000000, 31.000000)">
                        <path d="M18,12 C18,7.99999999 23,-1.06136056e-15 25.5,0 C28,1.06136055e-15 33,8 33,12 L33,46.0007795 C33,49.3140575 30.3183006,52 27.0069348,52 L23.9930652,52 C20.6831867,52 18,49.3133761 18,46.0007795 L18,12 Z" id="Rectangle-660" stroke="#2E3D49" stroke-width="2" stroke-linejoin="round" fill="#FAFBFC" sketch:type="MSShapeGroup"></path>
                        <g id="Group-2" transform="translate(19.000000, 1.000000)">
                            <mask id="mask-2" sketch:name="Mask" fill="white">
                                <use xlink:href="#path-1"></use>
                            </mask>
                            <use id="Mask" sketch:type="MSShapeGroup" xlink:href="#path-1"></use>
                            <path d="M6.5,-0.829781612 L6.5,36.3041058 L14.1093188,36.3041058 L14.1093188,8.07586463 C14.1093188,8.07586463 11.697392,0.642099693 11.6973919,0.642099676 C11.6973919,0.642099658 6.5,-0.829781612 6.5,-0.829781612 Z" id="Path-1236" fill="#DBE2E8" sketch:type="MSShapeGroup" mask="url(#mask-2)"></path>
                        </g>
                        <circle id="Oval-204" stroke="#2E3D49" stroke-width="2" fill="#F95C3C" sketch:type="MSShapeGroup" cx="25.5" cy="16.5" r="2.5"></circle>
                        <path d="M0,41.9333333 L18,22 L18,48 L0,48 L0,41.9333333 Z" id="Rectangle-666" stroke="#2E3D49" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="#FAFBFC" sketch:type="MSShapeGroup"></path>
                        <path d="M33,41.9333333 L51,22 L51,48 L33,48 L33,41.9333333 Z" id="Rectangle-666-Copy" stroke="#2E3D49" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="#FAFBFC" sketch:type="MSShapeGroup" transform="translate(42.000000, 35.000000) scale(-1, 1) translate(-42.000000, -35.000000) "></path>
                        <path d="M34,24.6248779 L41,47 L34,47 L34,24.6248779 Z" id="Path-1233" fill="#DBE2E8" sketch:type="MSShapeGroup"></path>
                        ...
                        <rect id="Rectangle-661-Copy-4" stroke="#2E3D49" stroke-width="2" fill="#ECC81A" sketch:type="MSShapeGroup" transform="translate(31.500000, 53.000000) scale(1, -1) translate(-31.500000, -53.000000) " x="26" y="50" width="11" height="6" rx="1"></rect>
                        <rect id="Rectangle-661-Copy-5" stroke="#2E3D49" stroke-width="2" fill="#ECC81A" sketch:type="MSShapeGroup" transform="translate(19.500000, 53.000000) scale(1, -1) translate(-19.500000, -53.000000) " x="14" y="50" width="11" height="6" rx="1"></rect>
                    </g>
                    <g id="arm" transform="translate(18.000000, 55.000000)" stroke="#2E3D49" stroke-width="2" sketch:type="MSShapeGroup">
                    ...
                    <g id="arm2" transform="translate(18.000000, 42.000000)" stroke="#2E3D49" stroke-width="2" sketch:type="MSShapeGroup">
                        <rect id="Rectangle-670" stroke-linejoin="round" x="0" y="0" width="12" height="4"></rect>
                        <path d="M8,0 L8,4" id="Line" stroke-linecap="square"></path>
                        <path d="M12,0 L12,4" id="Line-Copy-2" stroke-linecap="square"></path>
                    </g>
                    <g id="top-capsul" stroke="#2E3D49" stroke-width="2" fill="#DBE2E8" sketch:type="MSShapeGroup" stroke-linejoin="round">
                        <path d="M19,7 L19,3.99477117 C19,3.45092539 18.5546258,3 18.0052288,3 L5.99867589,3 C2.68193801,3 0,5.68569868 0,8.99867589 L0,21.0052288 C0,21.5490746 0.445374222,22 0.994771168,22 L4,22 L4,10.0001221 C4,8.3432004 5.3360431,7 7.00012207,7 L19,7 Z" id="Rectangle-667"></path>
